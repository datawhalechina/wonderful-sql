...
随着大数据技术的快速发展，SQL 应用能力日趋重要。 在诸多领域中 SQL 应用广泛，数据分析、开发、测试、维护、产品经理等都有可能会用到SQL，而在大学里系统性讲授 SQL 的课程较少，但是面试及工作中经常会涉及到 SQL。然而，自己学习很容易走弯路。笔者在多年的学习过程中，发现了一本很好的教材[《SQL基础教程 第2版》](https://book.douban.com/subject/27055712/)作者：MICK,
