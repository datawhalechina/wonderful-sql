...
custom安装模式可以自定义选择安装路径，包括安装路径和数据存放路径, (注意要安装组件至右侧，再进行点选, 之后点击 `Advanced Options` 按钮进行修改)(截图来源https://blog.csdn.net/jiangkun0331/article/details/106450875 ，特此感谢）。

![图片](./img/ch00/ch0005A.png)

![图片](./img/ch00/ch0005B.png)

![图片](./img/ch00/ch0005C.png)
